...
class StatelessDataAdaptorTest {
    ...
    @BeforeEach
    void setup() {
        assessmentCriteria.setAssessmentCriteriaDetails(Set.of(
    ...
    @Test
    void
            givenValidApplicantAndPartnerIncomes_whenMapIncomesToSectionSummariesIsInvoked_thenSectionSummariesAreReturned() {
        List<Income> incomes = List.of(
                buildIncome(
    ...
    @Test
    void
            givenValidApplicantAndPartnerOutgoings_whenMapOutgoingsToSectionSummariesIsInvoked_thenSectionSummariesAreReturned() {
        List<Outgoing> outgoings = List.of(
                buildOutgoing(
                        OutgoingType.COUNCIL_TAX,
                        BigDecimal.valueOf(500),
                        Frequency.ANNUALLY,
                        BigDecimal.valueOf(200),
                        Frequency.MONTHLY),
    ...
    void givenValidWeightsAndNoGroupings_whenMapChildGroupingsIsInvoked_thenMappingIsPerformed() {
        ...
        List<ApiAssessmentChildWeighting> expected = List.of(
                new ApiAssessmentChildWeighting().withChildWeightingId(1).withNoOfChildren(0),
                new ApiAssessmentChildWeighting().withChildWeightingId(2).withNoOfChildren(0),
                new ApiAssessmentChildWeighting().withChildWeightingId(3).withNoOfChildren(0));
    ...
    void givenValidWeightsAndGroupings_whenMapChildGroupingsIsInvoked_thenMappingIsPerformed() {
        ...
        List<ApiAssessmentChildWeighting> expected = List.of(
                new ApiAssessmentChildWeighting().withChildWeightingId(1).withNoOfChildren(1),
                new ApiAssessmentChildWeighting().withChildWeightingId(2).withNoOfChildren(0),
                new ApiAssessmentChildWeighting().withChildWeightingId(3).withNoOfChildren(2));
    ...
    private Income buildIncome(
        ...
        Income.IncomeBuilder builder = Income.builder()
                .incomeType(incomeType)
                .applicant(FrequencyAmount.builder()
                        .amount(applicantAmount)
                        .frequency(applicantFrequency)
                        .build());

        if (null != partnerAmount) {
            builder.partner(FrequencyAmount.builder()
    ...
    private Outgoing buildOutgoing(
            OutgoingType outgoingType, BigDecimal applicantAmount, Frequency applicantFrequency) {
