...
class CrownCourtEligibilityServiceTest {
    ...
    @Test
    void
            givenIndictableSentForTrialAndNoPreviousAssessments_whenIsEligibilityCheckRequiredIsInvoked_thenCorrectResultIsReturned() {
        requestDTO.setCaseType(CaseType.INDICTABLE);
        requestDTO.setMagCourtOutcome(MagCourtOutcome.SENT_FOR_TRIAL);
        softly.assertThat(crownCourtEligibilityService.isEligibilityCheckRequired(requestDTO))
                .isFalse();
    ...
    @Test
    void
            givenCCAlreadySentForTrialAndNoPreviousAssessments_whenIsEligibilityCheckRequiredIsInvoked_thenCorrectResultIsReturned() {
    ...
    void givenEWCommittedAndFirstAssessment_whenIsEligibilityCheckRequiredIsInvoked_thenCorrectResultIsReturned() {
        ...
        assertThat(crownCourtEligibilityService.isEligibilityCheckRequired(requestDTO))
                .isFalse();
    }
    ...
    void givenRepOrderWithNoAssessment_whenIsEligibilityCheckRequiredIsInvoked_thenExceptionIsThrown() {
        ...
        assertThatThrownBy(() -> crownCourtEligibilityService.isEligibilityCheckRequired(requestDTO))
                .isInstanceOf(RuntimeException.class)
                .hasMessage("Cannot find initial assessment with id: 8234");
    }

    @Test
    void
            givenEWCommittedReassessmentInitFailedAndDateCreatedOnMagsOutcomeDateSet_whenIsEligibilityCheckRequiredIsInvoked_thenTrueIsReturned() {
    ...
    @Test
    void
            givenEWCommittedReassessmentInitFailedAndDateCreatedAfterMagsOutcomeDateSet_whenIsEligibilityCheckRequiredIsInvoked_thenTrueIsReturned() {
        financialAssessment.setInitResult(InitAssessmentResult.FAIL.getResult());
    ...
    @Test
    void
            givenEWCommittedReassessmentInitFailedAndDateCreatedBeforeMagsOutcomeDateSet_whenIsEligibilityCheckRequiredIsInvoked_thenTrueIsReturned() {
        financialAssessment.setInitResult(InitAssessmentResult.FAIL.getResult());
    ...
    void givenPreviousAssessmentIsPassedInitMeans_whenIsEligibilityCheckRequiredIsInvoked_thenReturnFalse() {
        FinancialAssessmentDTO previous = FinancialAssessmentDTO.builder()
    ...
    void givenPreviousAssessmentIsFailedInitMeans_whenIsEligibilityCheckRequiredIsInvoked_thenReturnTrue() {
        FinancialAssessmentDTO previous = FinancialAssessmentDTO.builder()
                .initResult(InitAssessmentResult.FAIL.getResult())
                .build();
        repOrderDTO.getFinancialAssessments().add(previous);
        assertThat(crownCourtEligibilityService.isEligibilityCheckRequired(requestDTO))
                .isTrue();
    ...
    void givenPreviousAssessmentIsFailedFullMeans_whenIsEligibilityCheckRequiredIsInvoked_thenReturnFalse() {
        FinancialAssessmentDTO previous = FinancialAssessmentDTO.builder()
                .fullResult(FullAssessmentResult.FAIL.getResult())
                .build();
        repOrderDTO.getFinancialAssessments().add(previous);
        assertThat(crownCourtEligibilityService.isEligibilityCheckRequired(requestDTO))
                .isFalse();
    ...
    void givenPreviousAssessmentIsFailedPassport_whenIsEligibilityCheckRequiredIsInvoked_thenReturnTrue() {
        PassportAssessmentDTO previous = PassportAssessmentDTO.builder()
