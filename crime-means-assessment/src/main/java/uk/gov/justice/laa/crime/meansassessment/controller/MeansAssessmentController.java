...
public class MeansAssessmentController {
    ...
    private MeansAssessmentRequestDTO preProcessRequest(
            ApiMeansAssessmentRequest meansAssessment, RequestType requestType) {
    ...
    @DefaultHTTPErrorResponse
    public ResponseEntity<ApiMeansAssessmentResponse> createAssessment(
            @Parameter(
                            description = "Init means assessment data",
                            content =
                                    @Content(
                                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                    ...
                    @Valid
                    @RequestBody
                    ApiCreateMeansAssessmentRequest meansAssessment) {

        MeansAssessmentRequestDTO requestDTO = preProcessRequest(meansAssessment, CREATE);
        return ResponseEntity.ok(meansAssessmentService.doAssessment(requestDTO, CREATE));
    }
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                            ...
                            schema = @Schema(implementation = ApiMeansAssessmentResponse.class)))
    @DefaultHTTPErrorResponse
    public ResponseEntity<ApiMeansAssessmentResponse> updateAssessment(
            @Parameter(
                            description = "Init/Full means assessment data",
                            content =
                                    @Content(
                                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                    ...
                    @Valid
                    @RequestBody
                    ApiUpdateMeansAssessmentRequest meansAssessment) {

        MeansAssessmentRequestDTO requestDTO = preProcessRequest(meansAssessment, UPDATE);
        return ResponseEntity.ok(meansAssessmentService.doAssessment(requestDTO, UPDATE));
    }
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                            ...
                            schema = @Schema(implementation = ApiMeansAssessmentResponse.class)))
    @DefaultHTTPErrorResponse
    public ResponseEntity<ApiGetMeansAssessmentResponse> getOldAssessment(
