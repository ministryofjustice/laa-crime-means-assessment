...
public final class SortUtils {
    ...
    public static <T, U extends Comparable<? super U>, V extends Comparable<? super V>> void sortListWithComparing(
            List<T> t,
            Function<T, U> compFunction, Comparator<U> primaryComparator, Function<T, V> thenCompFunc, Comparator<V> secondComparator) {
        if (t != null) {
            t.sort(Comparator.comparing(compFunction, primaryComparator)
                    .thenComparing(thenCompFunc, secondComparator));
        }
    }
